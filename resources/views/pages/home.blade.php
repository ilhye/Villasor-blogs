...
<div class="row mt-3">
    ...
    <div class="col-md-4 col-sm-12 h-100">
        <p class="h5 recent-title border-bottom border-1 pb-2 mb-2 mt-sm-4">Recent Posts</p>
        @foreach($recent as $recentPost)
            <div class="card border-0 mb-3">
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <img src="{{ $recentPost->image_url }}" alt="cuteie cat" class="img-fluid rounded">
                    </div>
                    <div class="col-md-8 col-sm-6">
                        <div class="card-body p-0">
                            <p class="h5 mt-2 recent-content-title">{{ $recentPost->title }}</p>
                            <p class="small recent-content-main">{{ $recentPost->description }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-9 col-sm-12">
        <p class="h5 popular-title border-bottom border-1 pb-2 mt-5 mb-2">More Posts</p>
            ...
            <div class="card border-0 mb-3">
                <div class="row">
                    ...
                    <div class="col-6 col-md-9">
                        <div class="card-body p-0">
                            <p class="card-title h5 popular-content-title">{{ $post->title }}</p>
                            <p class="card-subtitle small text-secondary">Posted on {{ $post->created_at }} by {{ $post->author }}</p>
                            <p class="card-text mt-2 popular-description">{{ $post->description }}</p>
    ...
    <div class="col-md-3 col-sm-12">
        <div class="row">
            <div class="col-md-12 col-sm-6">
                <p class="h5 add-title border-bottom border-1 pb-2 mt-5 mb-2">Add Post</p>
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('pages.submit') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="description" id="post-description" rows="2"></textarea>
                                    </div>
                                    <div class="mb-3">
            ...
            <div class="col-md-12 col-sm-6 mb-sm-2">
                <p class="h5 social-title border-bottom border-1 pb-2 mt-5 mb-2">Follow us</p>
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        <i class="bi bi-facebook social-icon" style="font-size: 50px;"></i>
                    </div>
                    <div class="col-md-9 col-sm-9 mt-4">
                        <a href="https://www.facebook.com/" class="text-decoration-none text-black">facebook.com</a>
                    </div>
                    <div class="col-md-3 col-sm-3">
                        <i class="bi bi-twitter-x social-icon" style="font-size: 50px;"></i>
                    </div>
                    <div class="col-md-9 col-sm-9 mt-4">
                        <a href="https://x.com/" class="text-decoration-none text-black">X.com</a>
                    </div>
                </div>
            </div>
        </div>
